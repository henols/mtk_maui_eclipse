...
public class ShouldHaveBeenInCDT {
	/*
	 * Copied from wizard STDWizardHandler package package org.eclipse.cdt.managedbuilder.ui.wizards;; This method creates the .cProject
	 * file in your project.
	 *
	 * BK: modified this and made it work for multiple configs.
	 */
	/**
	 * This method creates the .cProject file in your project. it is intended to be used with newly created projects. Using this method with
	 * project that have existed for some time is unknown
	 *
	 *
	 * @param project
	 ...
	 */
	public static ICProjectDescription setCProjectDescription(IProject project, String toolChainId, boolean isManagedBuild, IProgressMonitor monitor)
			throws CoreException {
		...
		Configuration cfg = new Configuration(mProj, (ToolChain) tcs, ManagedBuildManager.calculateChildId(toolChainId, null), configName);
	...
	private static void setDefaultLanguageSettingsProviders(IProject project, String toolChainId, IConfiguration cfg,
